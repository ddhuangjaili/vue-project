    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          add: 'vc_coupon_client_add',
          search: 'vc_coupon_client_view',
          edit: 'vc_coupon_client_edit',
          auth: 'vc_coupon_client_auth',
          charge: 'vc_coupon_client_charge',
          clientStatus: 'vc_coupon_client_update_client_status',
          clientGroup: 'vc_coupon_client_update_client_group',
          accountStatus: 'vc_coupon_client_update_account_status',
          accountFlag: 'vc_coupon_client_update_account_flag',
          authCodeList: 'vc_coupon_client_auth_code_list',
          uploadConfig: 'vc_coupon_client_upload_config',
          openAccount: 'vc_coupon_client_open_account',
          categoryAuth:'vc_coupon_client_category_auth',
          export: 'vc_coupon_client_export',
          tradeInit: 'vc_coupon_client_trade_init'
        });
      },
      hasBankCard() {
