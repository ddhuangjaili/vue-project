        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="应用编码：">
              <el-input v-model="dialog.form.appCode" auto-complete="off" readonly></el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'ms_center_admin_message_stat_view'
        });
      }
    },
    methods: {
      ...
      query () {
        ...
        api.adminStatMessage(params).then((res) => {
          this.loading = false;
          let data = res.data;
          if (data && data.code === '0') {
