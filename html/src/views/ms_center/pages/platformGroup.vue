    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'ms_center_platformGroup_view',
          add: 'ms_center_platformGroup_add',
          edit: 'ms_center_platformGroup_edit',
          del: 'ms_center_platformGroup_del'
        });
      }
    },
    methods: {
              ...
              api.addPlatformGroup(params.appCode, params).then((res) => {
                ...
                if (data && data.code === '0') {
                  ...
                  bsmp.log({
                    component: 'ms_center',
                    type: 'add',
                    content: `[PlatformGroup] params: ${JSON.stringify(params)}`
                  });
                }
              });
            } else {
