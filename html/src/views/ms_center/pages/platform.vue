    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'ms_center_platform_view',
          add: 'ms_center_platform_add',
          edit: 'ms_center_platform_edit',
          del: 'ms_center_platform_del'
        });
      }
    },
    methods: {
              ...
              api.addPlatform(params.appCode, params).then((res) => {
                ...
                if (data && data.code === '0') {
                  ...
                  bsmp.log({
                    component: 'ms_center',
                    type: 'add',
                    content: `[Platform] params: ${JSON.stringify(params)}`
                  });
                }
              });
            } else {
