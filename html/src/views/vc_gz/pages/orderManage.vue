    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'vc_gz_order_manage_view',
          getOrderOp: 'vc_gz_order_manage_getOrderOp',
          approve: 'vc_gz_order_manage_approve',
          cancel: 'vc_gz_order_manage_cancel',
          cancelAppeal: 'vc_gz_order_manage_cancelAppeal',
          status: 'vc_gz_order_manage_status',
          export: 'vc_gz_order_manage_export'
        });
      }
    },
    methods: {
