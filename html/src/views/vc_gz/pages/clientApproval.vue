    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-show="scope.row.approveType == 4" type="primary" size="small"><a :href="scope.row.videoAuthUrl" target="_blank" class="download-link" download="w3logo"><i class="icon-download"></i>下载</a></el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'vc_gz_client_approval_view',
          approval: 'vc_gz_publishCur_approval',
        });
      }
    },
    methods: {
      ...
      showDialog(index) {
          ...
          this.imagesMap.front.url=form.frontIdCard;
          this.imagesMap.back.url=form.backIdCard;
          this.imagesMap.holdon.url=form.holdonIdCard;
