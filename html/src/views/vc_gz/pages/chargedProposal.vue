    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'vc_gz_chargedProposal_view',
          approved:'vc_gz_chargedProposal_approved',
          cancel:'vc_gz_chargedProposal_cancel',
          del: 'vc_gz_chargedProposal_del',
          batch: 'vc_gz_chargedProposal_batch'
        });
      }
    },
    methods: {
