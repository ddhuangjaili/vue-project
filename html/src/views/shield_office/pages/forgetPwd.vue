    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'shield_office_forgetPwd_view',
          approve: 'shield_office_forgetPwd_approve'
        });
      }
    },
    methods: {
      ...
      batchSetApproval(params) {
        api.approveForgetPwd(params).then((res) => {
          let data = res.data;
          if (data && data.code === '0') {
            this.$message({
              type: 'success',
            ...
            bsmp.log({
              ...
              type: 'approve',
              content: `[forgetPwd] params: ${JSON.stringify(params)}`
            });
          }
        });
      },
      ...
      query() {
        ...
        api.getForgetPwdList(params).then((res) => {
          this.loading = false;
          let data = res.data;
          if (data && data.code === '0') {
