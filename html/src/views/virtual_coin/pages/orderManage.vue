    ...
    <query-panel>
      <el-form :inline="true" :model="search" class="demo-form-inline">
        <el-form-item>
          ...
          <el-form-item>
              <el-input v-model="search.goodsId" placeholder="广告ID"></el-input>
          </el-form-item>
        <el-form-item>
    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'virtual_coin_order_manage_view',
          getOrderOp: 'virtual_coin_order_manage_getOrderOp',
          approve: 'virtual_coin_order_manage_approve',
          cancel: 'virtual_coin_order_manage_cancel',
          cancelAppeal: 'virtual_coin_order_manage_cancelAppeal',
          status: 'virtual_coin_order_manage_status',
          export: 'virtual_coin_order_manage_export'
        });
      }
    },
    methods: {
