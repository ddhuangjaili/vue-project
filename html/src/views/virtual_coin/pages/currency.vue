    ...
    computed: {
      optAuth() {
        return bsmp.util.mapAuth({
          search: 'virtual_coin_currency_view',
          add: 'virtual_coin_currency_add',
          edit: 'virtual_coin_currency_edit',
          del: 'virtual_coin_currency_del',
          batch: 'virtual_coin_currency_batch'
        });
      }
    },
    methods: {
